...
export default function joinDao() {
  ...
  const address = [
    ...
    "0x85134cC0A528a9aF0E7C7c7A2Df707E6ddF16180",
  ...
  const createproposal = async (event: any) => {
    ...
    const contract = new ethers.Contract("0x37F9e87c6599Dc455a0181CB9438fE0f4a5C54b4", spruceDaoAbi, signer);
    const txn = await contract.proposal("Arbitrum Ambassador Program", "Arbitrum Ambassador Program");
    console.log(txn);
  };
  async function lend() {
    const web3Modal = new Web3Modal();
    ...
    const txn = await contract.lend("0xc59e2441bD6b8b47E207E4cD40EbD0CD35c85aaF", 1, options);
    console.log(txn);
  }
        ...
        {eligibleForCredit && (
          <>
                ...
                <li key={person} className="flex justify-between gap-x-6 py-5">
                  <div className="flex min-w-0 gap-x-4">
                    <img
                      ...
                      src={
                        useEnsAvatar({ name: useEnsName({ address: person, chainId: 5 })?.data, chainId: 5 })?.data ||
                        undefined
                      }
                      alt=""
                    />
                    <div className="min-w-0 flex-auto">
                      <p className="text-sm font-semibold leading-6 text-gray-900">
                        {useEnsName({ address: person, chainId: 5 })?.data}
                      </p>
            ...
            <form
              ...
              style={{ marginTop: "700px", display: "flex", justifyContent: "center", justifyItems: "center" }}
            >
              <div>
                <div
