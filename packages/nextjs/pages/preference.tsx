...
export default function Create() {
  ...
  const [secondaryAddresssess, setSecondaryAddressess] = useState([]);
...
const deployContract=async(event:any)=>{
  ...
  return (
    <div>
     ...
     <h1 style={{display:"flex",justifyContent:"center",justifyItems:"center",fontSize:"30px"}}>Set your preferences</h1>
        ...
        Add Input
              ...
              <div className="mt-2">
                <select
                    ...
                    value={selectedOption} onChange={handleCurrencyChange}
                  autoComplete="country-name"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                >
